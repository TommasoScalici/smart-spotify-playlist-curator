...
export const config = {
  get SPOTIFY_CLIENT_ID() { return getConfig().SPOTIFY_CLIENT_ID; },
  get SPOTIFY_CLIENT_SECRET() { return getConfig().SPOTIFY_CLIENT_SECRET; },
  get SPOTIFY_REFRESH_TOKEN() { return getConfig().SPOTIFY_REFRESH_TOKEN; },
  get GOOGLE_AI_API_KEY() { return getConfig().GOOGLE_AI_API_KEY; },
  get SPOTIFY_REDIRECT_URI() { return getConfig().SPOTIFY_REDIRECT_URI; },
};
