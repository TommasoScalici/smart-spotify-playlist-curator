...
describe('ConfigService', () => {
    ...
    const mockConfig: PlaylistConfig = {
        ...
        aiGeneration: { prompt: "Test prompt", model: "gemini-2.5-flash", temperature: 0.7 },
    ...
    it('should validate fetched config using Zod schema', async () => {
        ...
        expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Invalid configuration'), expect.any(Object));
    });
