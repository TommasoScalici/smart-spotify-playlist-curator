...
export default function Dashboard() {
    ...
    return (
        <div>
            <div className="dashboard-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'end' }}>
                <div>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                    <button
                        ...
                        style={{ background: 'var(--bg-surface-elevated)', border: '1px solid var(--border-subtle)', color: 'white' }}
