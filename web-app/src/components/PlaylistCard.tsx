...
import { PlaylistConfig } from '../types/schemas';
...
export const PlaylistCard = ({ config }: PlaylistCardProps) => {
    ...
    return (
        <div className="glass-panel status-card" style={{ height: 'auto', minHeight: '220px', alignItems: 'flex-start', textAlign: 'left' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    {config.imageUrl ? (
                        <div style={{
                            ...
                            <img src={config.imageUrl} alt={config.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                        </div>
                    ) : (
                        <div style={{
                            width: '64px',
                    ...
                    <div>
                        ...
                        {config.owner && <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '4px' }}>by {config.owner}</div>}
                        <span style={{
                            fontSize: '0.75rem',
